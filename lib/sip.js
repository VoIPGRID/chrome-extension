    ...
    window.SIP = (function() {
        var init = function(options) {
            ...
            var eventsListener = function(e) {
                console.log(new Date(), 'windows.SIP.event:', ''+ e.type + ' (' + e.o_event.i_code + ')');
        ...
        var start = function() {
            ...
            if((!code || code == tsip_event_code_e.STACK_STOPPED) && sipStack) {
                subscriptions = {};
                states = {};
                sipStack.start();
            } else {
                console.log('SIP.start skipped because status is', status);
            }
        };
        ...
        var subscribe = function(to) {
            if(code == tsip_event_code_e.STACK_STARTED && subscriptions) {
                ...
                console.log('not subscribing because status is', status);
            }
        };
        ...
        var unsubscribe = function(from) {
            ...
            if(subscriptions.hasOwnProperty(from)) {
                ...
                delete states[from];
                // console.log('SIP unsubscribed from', from);
            } else {
                // console.log('SIP not unsubscribed from', from);
            }
        };
