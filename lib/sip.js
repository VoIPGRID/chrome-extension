(function() {
    ...
    window.SIP = (function() {
        // The retry timer is used to determine when to retry to
        // reconnect to the websocket backend, as soon the websocket
        // connection is closed. This should prevent a self-inflicted DDOS.
        let retry;
            ...
            switch(code) {
                ...
                case tsip_event_code_e.STACK_FAILED_TO_START:
                    ...
                    if(reconnect) {
                        ...
                        timer.setTimeout('contacts.reconnect', retry.jittered);
